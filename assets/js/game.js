...
var fightOrSkip = function() {
  // ask player if they'd like to fight or skup using fightOrSkip function
  ...
  if ([prompFight === "" || promptFight === null]) {
  ...
  if (promptFight === "skip") {
// confirm player wants to skip
var confirmSkip = window.confirm("Are yo sure you'd like to quit?");
...
var fight = function(enemy) {
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    if (confirmSkip) {
      ...
      // substract moneyf rom playerMoney for skiping, but don't let them go into the negative
  ...
  return false;
    ...
    if (!promptFight === "") {
      // confirm player wants to skip
      window.confirm("You need to provide a valid answer");
      return fightOrSkip();
    }
